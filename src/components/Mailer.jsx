...
const Mailer = () => {
  ...
  return (
    <div className="py-20  px-4 mx-auto max-w-screen-md mt-[30%] sm:mt-[25%] md:mt-[20%] lg:mt-[15%] xl:mt-[10%]">
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 text-sm sm:text-lg xl:text-xl">
      ...
      <form action="#" className="space-y-8" onSubmit={(e) => sendEmail(e)}>
        <div>
          <label
            htmlFor="email"
            className="block mb-2 text-base xl:text-lg font-medium text-gray-900 dark:text-gray-300"
          >
            Your email
          </label>
          <input
            ...
            className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-base xl:text-lg rounded-lg
        ...
        <div>
          ...
          <input
            ...
            name="user_name"
            onChange={handleChange}
            className="block p-3 w-full text-base xl:text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm 
        ...
        <div className="sm:col-span-2">
          <label
            htmlFor="message"
            className="block mb-2 text-base xl:text-lg font-medium text-gray-900 dark:text-gray-400"
          >
            Your message
          </label>
          <textarea
            ...
            onChange={handleChange}
            rows="6"
            className="block p-2.5 w-full text-base xl:text-lg text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 
              focus:ring-primary-500 focus:border-primary-500
              "
