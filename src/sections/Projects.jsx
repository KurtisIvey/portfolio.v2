...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      className="relative h-screen landscape:h-full flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly 
    ...
    >
      ...
      <div
        className="relative w-full h-fit flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 mx-auto max-w-[90%]  landscape:mt-[20%] 
