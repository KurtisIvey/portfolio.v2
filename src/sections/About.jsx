...
const About = () => {
  return (
    ...
    >
      <h3 className="absolute sm:top-24 top-14  uppercase tracking-[20px] text-gray-500 text-2xl xl:text-4xl ml-6">
        About
      </h3>

      <div className=" grid grid-cols-1 lg:grid-cols-2 h-[71%]  mt-[30%] sm:mt-[25%]   gap-2 md:gap-4 ">
        <ImageCarousel />
        <div className="text-xs text-xs sm:text-base lg:text-lg xxl:text-xl flex flex-col justify-center mr-1 mt-[5%]">
          <p>
          ...
          <p className="text-[.6rem]  sm:text-base lg:text-lg xxl:text-xl">
