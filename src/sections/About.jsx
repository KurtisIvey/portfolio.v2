...
const About = () => {
  return (
    <div className="relative h-screen flex flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly items-center mx-auto">
      <h3 className="absolute sm:top-24 top-14  uppercase tracking-[20px] text-gray-500 text-2xl sm:ml-0 ml-3">
        About
      </h3>
      <div className=" grid grid-cols-1 sm:grid-cols-2 h-fit mt-20 sm:mt-0 gap-2 sm:gap-10">
        <ImageCarousel />
